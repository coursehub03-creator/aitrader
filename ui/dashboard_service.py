...
class DashboardService:
    ...
    def recommendation_to_record(recommendation: FinalRecommendation) -> dict[str, Any]:
        ...
        return {
            ...
            "historical_score": recommendation.historical_score if recommendation.historical_score is not None else "",
            "recent_score": recommendation.recent_score if recommendation.recent_score is not None else "",
            "combined_score": recommendation.combined_score if recommendation.combined_score is not None else "",
